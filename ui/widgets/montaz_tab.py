...
class MontazTab(QWidget):
    ...
    def load_from_record(self, rec: ServiceRecord):
        ...
        try:
            ...
            self._plate_format_cb.setChecked(rec.config_json.get("plateFormatFree", False))
            self._id_format_cb.setChecked(rec.config_json.get("idFormatFree", False))
            self._przek_format_cb.setChecked(rec.config_json.get("przekFormatFree", False))
    ...
    def collect_to_record(self, rec: ServiceRecord) -> Tuple[bool,str]:
        ...
        plate_raw = self._plate_edit.text().strip()
        rec.license_plate  = plate_raw if self._plate_format_cb.isChecked() else plate_raw.upper()
        ...
        rec.config_json["plateFormatFree"] = self._plate_format_cb.isChecked()
        rec.config_json["idFormatFree"] = self._id_format_cb.isChecked()
        rec.config_json["przekFormatFree"] = self._przek_format_cb.isChecked()
